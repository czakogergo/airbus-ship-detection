...
\section*{Nyilatkozat mesterséges intelligencia használatáról}

A szerzők nyilatkoznak, hogy a dolgozat elkészítése során generatív
mesterséges intelligencia alapú eszközöket, köztük a ChatGPT-t
használtak. Az eszközök elsősorban a szöveg megfogalmazásának
finomításához, technikai kérdések tisztázásához, valamint egyes
módszertani döntések - például a veszteségfüggvény kiválasztása és a
kiértékelési megközelítés - megvitatásához nyújtottak támogatást.

A megoldás koncepcionális tervezését, a neurális hálózat
megvalósítását, a kísérletek elvégzését és az eredmények értelmezését a
szerzők önállóan végezték. Az AI által generált tartalmak minden esetben
ellenőrzésre és szakmai validálásra kerültek.
